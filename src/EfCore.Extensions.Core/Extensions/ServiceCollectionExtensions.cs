...
using EfCore.Extensions.Core.Interceptors;
using EfCore.Extensions.Core.Repositories;
using EfCore.Extensions.Core.UnitOfWork;
...
/// <summary>
/// Extension methods for <see cref="IServiceCollection"/> to register EfCore.Extensions services.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds EfCore.Extensions services and configures the specified <typeparamref name="TContext"/>.
    /// </summary>
    ...
    /// <param name="configureOptions">Optional EfCore.Extensions feature configuration.</param>
