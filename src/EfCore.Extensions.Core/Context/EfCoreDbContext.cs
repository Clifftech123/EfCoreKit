...
using EfCore.Extensions.Core.Filters;
    ...
    where TContext : DbContext
{
    ...
    /// <param name="kitOptions">The EfCore.Extensions configuration options.</param>
    ...
    /// <summary>
    /// Gets the current EfCore.Extensions configuration options.
    /// </summary>
