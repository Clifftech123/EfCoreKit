...
/// and slow query logging via EF Core interceptors.
/// </summary>
/// <remarks>
...
///
/// Save-pipeline behaviour (audit, soft delete) is handled by dedicated
/// <see cref="Microsoft.EntityFrameworkCore.Diagnostics.SaveChangesInterceptor"/>
    ...
    where TContext : DbContext
{
    ...
    /// <summary>
    /// Applies the soft-delete global query filter.
    /// </summary>
