...
namespace EfCore.Extensions.Core.Interceptors;
...
internal sealed class TenantInterceptor : SaveChangesInterceptor
{
    ...
    /// </summary>
    /// <param name="options">The EfCore.Extensions configuration options.</param>
    /// <param name="tenantProvider">The tenant provider for resolving the current tenant.</param>
    public TenantInterceptor(EfCoreOptions options, ITenantProvider? tenantProvider = null)
    {
        _options = options;
